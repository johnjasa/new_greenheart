...
from new_greenheart.core.finances import ProFastComp
...
def test_electrolyzer_refurb_results():
    ...
    prob.set_val('capex_adjusted_electrolyzer', 1.e7, units='USD')
    prob.set_val('opex_adjusted_electrolyzer', 1.e4, units='USD/year')

    prob.set_val('total_hydrogen_produced', 4.e5, units='kg/year')
    prob.set_val('time_until_replacement', 5.e3, units='h')
