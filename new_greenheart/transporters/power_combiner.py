...
class CombinerPerformanceModel(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output('electricity_output', val=0.0, copy_shape='electricity_input1', units='kW')

    def compute(self, inputs, outputs):
        outputs['electricity_output'] = inputs['electricity_input1'] + inputs['electricity_input2']
